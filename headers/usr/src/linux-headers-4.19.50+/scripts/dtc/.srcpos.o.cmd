cmd_scripts/dtc/srcpos.o := gcc -Wp,-MD,scripts/dtc/.srcpos.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89     -Iscripts/dtc/libfdt  -c -o scripts/dtc/srcpos.o scripts/dtc/srcpos.c
