...
#define TSK_ACTIVE_MM 812 /* offsetof(struct task_struct, active_mm) */
#define TSK_STACK_CANARY 944 /* offsetof(struct task_struct, stack_canary) */
...
#define SIZEOF_MACHINE_DESC 120 /* sizeof(struct machine_desc) */
