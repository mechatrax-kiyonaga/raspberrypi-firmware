...
#define TSK_STACK_CANARY 1336 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6528 /* offsetof(struct task_struct, thread.cpu_context) */
...
#define VCPU_FAULT_DISR 2168 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_WORKAROUND_FLAGS 2176 /* offsetof(struct kvm_vcpu, arch.workaround_flags) */
#define VCPU_HCR_EL2 2128 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
#define CPU_GP_REGS 0 /* offsetof(struct kvm_cpu_context, gp_regs) */
#define CPU_APIAKEYLO_EL1 1640 /* offsetof(struct kvm_cpu_context, sys_regs[APIAKEYLO_EL1]) */
#define CPU_APIBKEYLO_EL1 1656 /* offsetof(struct kvm_cpu_context, sys_regs[APIBKEYLO_EL1]) */
#define CPU_APDAKEYLO_EL1 1672 /* offsetof(struct kvm_cpu_context, sys_regs[APDAKEYLO_EL1]) */
#define CPU_APDBKEYLO_EL1 1688 /* offsetof(struct kvm_cpu_context, sys_regs[APDBKEYLO_EL1]) */
#define CPU_APGAKEYLO_EL1 1704 /* offsetof(struct kvm_cpu_context, sys_regs[APGAKEYLO_EL1]) */
#define CPU_USER_PT_REGS 0 /* offsetof(struct kvm_regs, regs) */
#define HOST_CONTEXT_VCPU 1752 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
